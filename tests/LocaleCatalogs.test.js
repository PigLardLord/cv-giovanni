...
const read = (locale, namespace) => JSON.parse(fs.readFileSync(
  path.join(root, 'locales', locale, `${namespace}.json`), 'utf8'
));
const leafKeys = (object, prefix = '') => Object.entries(object).flatMap(([key, value]) => {
