...
// page, where 42.6px came back as 43px and passed the 43px floor the Download link is held to (#109). That button
// went with the footer (#150); the link's own measurement is still read here.
...
describe('the screen audit hands its judges what the page measured', () => {
  test.each([['downloadLinks', /height: box\.height/]])(
    '%s measures a height and rounds nothing',
    (name, height) => {
